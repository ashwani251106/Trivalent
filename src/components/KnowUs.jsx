  ...
  const team = [
    {
      ...
      detailedBio: "I architect the core infrastructure and immersive interfaces that allow modern applications to scale seamlessly. With a deep background in distributed systems and cloud orchestration, I bridge the gap between high-performance  frontend experiences with bulletproof backend services. By optimizing complex database architectures and streamlining DevOps pipelines, I ensure every product is built for maximum speed, security, and global elasticity.",
